...
export default function BottomNavBar({
  ...
  return (
    <>
      ...
      >
        {/* Sol Taraf - Profil + Masada Ne Var */}
        ...
        {/* Orta - Garson Çağır (Floating Action Button) */}
        {showWaiterCall && (
          <div
            className="waiter-call-container"
          ...
          >
            {/* Parlayan Halka */}
            <div className="waiter-glow-ring" />

            <div
              className="waiter-icon-container"
              style={{
                width: '56px',
                height: '56px',
        ...
        {/* Orta boşluk - Garson yoksa */}
        {!showWaiterCall && <div style={{ width: '70px' }} />}

        {/* Sağ Taraf - AI + Oyun + Sepet */}
      ...
      <style jsx>{`
        ...
        .waiter-call-container {
          animation: waiterPulse 2s ease-in-out infinite;
        }

        .waiter-call-container:hover {
          transform: scale(1.1);
        }

        .waiter-call-container:active {
          transform: scale(0.95);
        }

        .waiter-icon-container {
          animation: waiterGlow 2s ease-in-out infinite;
        }
        ...
        .waiter-glow-ring {
          ...
          border-radius: 50%;
          animation: waiterRingPulse 2s ease-out infinite;
          pointer-events: none;
        }
      `}</style>
    </>
